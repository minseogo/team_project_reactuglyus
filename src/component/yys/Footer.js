...
function Footer() {
  ...
  return (
    <footer id='yfooter' className='mb-5 section_blankT'>
      <div className='fm_menu d-lg-flex d-none d-lg-block justify-content-between align-items-center mb-2 font_base'>
      ...
      <div className={`d-none d-lg-block font_base mb-5 day_help ${isHelpVisible ? 'd-block' : 'd-none'}`}>
